...
base_interp = readtable('line20_interps.csv', 'NumHeaderLines',2);
...
plot(imo_long_x(3:491),0.5*t_max*v1, 'm*','LineWidth',4);
...
figure(4);
subplot 121
plot((10*log10(amplitude(:,trace_a).^2)),0.5*v1*imo_long_t,'k','LineWidth',2); hold on;
plot(10*log10(power(trace_a)),0.5*t_max(trace_a)*v1, 'r*');
axis ij; 
ylim([0 50]);

subplot 122
plot((10*log10(amplitude(:,trace_b).^2)),0.5*v1*imo_long_t,'k','LineWidth',2); hold on;

plot(10*log10(power(trace_b)),0.5*t_max(trace_b)*v1, 'r*');axis ij; 
ylim([0 50]);

figure(5);
pcolor(imo_long_x, 0.5*v1*imo_long_t, 10*log10(amplitude.^2)); hold on;
plot([trace_a trace_a],[0 50],'r','LineWidth',2); hold on;
plot([trace_b trace_b],[0 50],'r','LineWidth',2);
plot(imo_long_x(3:491), 0.5*v1*t_max,'r*', 'LineWidth', 4);
...
figure(6);
scatter(base_depth(3:491),10*log10(power(3:491)),'k');hold on;
scatter(base_depth(3:491),10*log10(geometric_correction2(3:491)),'r');
scatter(base_depth(3:491),10*log10(geometric_correction3(3:491)),'b');
scatter(base_depth(3:491),10*log10(geometric_correction4(3:491)),'c');


fit = polyfit(base_depth(3:491),10*log10(power(3:491)),1);
fit2 = polyfit(base_depth(3:491),10*log10(geometric_correction2(3:491)),1);
fit3 = polyfit(base_depth(3:491),10*log10(geometric_correction3(3:491)),1);
fit4 = polyfit(base_depth(3:491),10*log10(geometric_correction4(3:491)),1);
