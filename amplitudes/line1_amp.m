...
amplitude = line1;
% 
% imo_long_topo = rmmissing(readtable('imo_long_topo_hires.csv')); topo_z = (imo_long_topo.z);
% topo_x = imo_long_topo.x;
% topo_E = imo_long_topo.E;
% topo_N = imo_long_topo.N;

base_interp = readtable('sc_base-Point.csv', 'NumHeaderLines',3);
...
plot(imo_long_x(34:438), 0.5*v1*t_max,'r*', 'LineWidth', 4);
...
figure(6);
scatter(base_depth(34:438),10*log10(power(34:438)),'k');hold on;
scatter(base_depth(34:438),10*log10(geometric_correction2(34:438)),'r');
scatter(base_depth(34:438),10*log10(geometric_correction3(34:438)),'b');
scatter(base_depth(34:438),10*log10(geometric_correction4(34:438)),'c');
